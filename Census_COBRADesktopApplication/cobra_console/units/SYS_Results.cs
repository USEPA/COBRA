...
namespace cobra_console.units
{
    ...
    public partial class SYS_Results
    {
        ...
        public Nullable<double> PM_Asthma_Symptoms_Chest_Tightness { get; set; }
        public Nullable<double> C__PM_Asthma_Symptoms_Chest_Tightness { get; set; }
        ...
        public Nullable<double> HA_Lower_Respiratory_Infection { get; set; }
        public Nullable<double> C__HA_Lower_Respiratory_Infection { get; set; }
        ...
        public Nullable<double> IRA { get; set; }
