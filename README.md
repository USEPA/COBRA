...
1. The Desktop application (County_COBRADesktopApplication). The data for the desktop application can be found within the installer that is downloaded from https://www.epa.gov/cobra/forms/download-cobra-and-sign-updates.
