...
export class CobraDataService {
  ...
  getPopulationData() {
    return this.http.get<any[]>(this.serverendpoint + 'Population');
  }

  getAllTribes() {
    return this.http.get<any[]>(this.serverendpoint + 'Tribe');
  }
  ...
  getGeoDataforCensusTracts(fileType: 'simple' | 'full'): Observable<any> {
    return this.http.get(`${this.serverendpoint}CensusTracts?fileType=${fileType}`, { responseType: 'json' });
  }
